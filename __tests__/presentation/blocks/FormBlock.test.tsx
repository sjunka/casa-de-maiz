...
import type { FormBlock as FormBlockData } from '@core/contract/models/blocks/block';

jest.mock('@data/remote/fetchers/formSubmission', () => ({ submitFormSubmission: jest.fn() }));
