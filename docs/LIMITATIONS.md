...
- **Universal Links / Android App Links.** Out of scope: no domain the assessment lets us verify ownership of. The `casamaiz://` custom scheme is implemented.
